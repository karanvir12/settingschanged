...
digraph {
    ...
    TransientValidationData:balance -> "peer_core_primitives::v2::Balance":w
    ...
    CandidateCommitments:horizontal_messages -> "peer_core_primitives::v2::OutboundHrmpMessage":w
...
digraph {
    ...
    RelayChainBlockNumber [label = "peer_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "peer_core_primitives::OutboundHrmpMessage"]
}
```

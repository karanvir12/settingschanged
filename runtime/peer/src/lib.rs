...
parameter_types! {
	pub LaunchPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 2 * MINUTES, "peer_LAUNCH_PERIOD");
	pub VotingPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 2 * MINUTES, "peer_VOTING_PERIOD");
	pub FastTrackVotingPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 2 * MINUTES, "peer_FAST_TRACK_VOTING_PERIOD");
	pub const MinimumDeposit: Balance = 100 * DOLLARS;
	pub EnactmentPeriod: BlockNumber = prod_or_fast!(2 * MINUTES,2 * MINUTES, "peer_ENACTMENT_PERIOD");
	pub CooloffPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 2 * MINUTES, "peer_COOLOFF_PERIOD");
...
parameter_types! {
	...
	pub const LeasePeriod: BlockNumber = 2 * MINUTES;
